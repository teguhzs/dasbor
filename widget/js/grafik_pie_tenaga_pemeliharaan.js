var optionsPieTenagaPemeliharaan = {
  ...
  title: {
    text: "Realisasi Tenaga Pemeliharaan Terhadap RKAP",
    floating: false,
    style: {
      fontSize: "10px",
      color: "#fff",
...
var d_pieTenagaPemeliharaan = new ApexCharts(
  document.querySelector("#pieTenagaPemeliharaan"),
  optionsPieTenagaPemeliharaan
);
