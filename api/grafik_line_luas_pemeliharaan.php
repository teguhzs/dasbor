...
while ($i <= $hariBulanIni) {
    ...
    $query1 = mysql_query("SELECT IFNULL(SUM(drp.luas),0) as luas_pemeliharaan
    ...
    $rkap[] = array(
        'x' => '' . $i . '',
        'y' => $row1['luas_pemeliharaan'],
    );

    $query2 = mysql_query("SELECT IFNULL(SUM(drp.luas),0) as luas_pemeliharaan
